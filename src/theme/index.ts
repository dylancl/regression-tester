        ...
        styleOverrides: {
          root: {
            ...
            background: mode === 'light'
              ? `linear-gradient(to right, ${toyotaRed}, ${alpha(toyotaRed, 0.95)})`
              : `linear-gradient(to right, ${toyotaRed}, ${alpha(lexusRed, 0.95)})`,
          },
        },
      },
      MuiDivider: {
      ...
      MuiToggleButton: {
        styleOverrides: {
          root: {
            ...
            "&.Mui-selected": {
              color: mode === 'light' ? toyotaRed : '#FF3B4E',
              backgroundColor: mode === 'light' ? alpha(toyotaRed, 0.1) : alpha(toyotaRed, 0.2),
              "&:hover": {
                backgroundColor: mode === 'light' ? alpha(toyotaRed, 0.15) : alpha(toyotaRed, 0.25),
              },
            },
          },
        },
