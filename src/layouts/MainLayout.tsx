...
const MainLayout = ({ children }: MainLayoutProps) => {
  ...
  const isTestManagementPage = location.pathname === "/test-management";
          ...
          {isMobile ? (
            ...
            <>
              ...
              >
                ...
                <MenuItem
                  ...
                  to="/test-management"
                  onClick={handleMobileMenuClose}
                  selected={isTestManagementPage}
                  sx={{
                    color: isTestManagementPage
                      ? theme.palette.primary.main
                      : "inherit",
                    fontWeight: isTestManagementPage ? 500 : 400,
                  }}
                >
            ...
            <Stack direction="row" spacing={1}>
              ...
              <Button
                component={Link}
                to="/test-management"
                variant={isTestManagementPage ? "contained" : "text"}
                color="inherit"
                startIcon={<Assignment />}
                sx={{
                  bgcolor: isTestManagementPage
                    ? "rgba(255, 255, 255, 0.15)"
                    : "transparent",
                  "&:hover": {
                    bgcolor: isTestManagementPage
